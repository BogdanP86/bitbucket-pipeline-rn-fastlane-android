...
# ENV ANDROID_SDK_COMPONENTS platform-tools,build-tools-27.0.3,android-27,extra-android-support,extra-android-m2repository
...
RUN apt-get install -y rubygems rubygems-integration ruby-all-dev ruby-dev build-essential autoconf build-essential libssl-dev libreadline6-dev zlib1g-dev libncurses5-dev libffi-dev libgdbm3 libgdbm-dev
